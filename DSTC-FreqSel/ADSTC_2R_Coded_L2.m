...
q1=[q11(nSim),zeros(1,Tm),q12(nSim)];
q2=[q21(nSim),zeros(1,Tm),q22(nSim)];
g1=[0,alfa1*g11(nSim),beta1*g11(nSim),zeros(1,Tm-2),alfa1*g12(nSim),beta1*g12(nSim)];
g2=[beta22*g21(nSim),alfa2*g21(nSim),beta2*g21(nSim),zeros(1,Tm-2),alfa2*g22(nSim),beta2*g22(nSim)];
